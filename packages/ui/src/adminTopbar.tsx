...
export function AdminTopbar() {
    ...
    const[, SetAddProductModalOpen] = useAtom(AddProductAtom);
    ...
    useEffect(() => {
      ...
      return <div className={`z-40 drop-shadow-xl fixed w-full bg-white h-[12%] justify-between items-center flex p-5 dark:bg-black dark:text-white duration-300 transition-all 
      ...
      <div className="flex gap-2 ">
        ...
        <div className="cursor-pointer"
        onClick={() => {SetAddProductModalOpen(true), setBlurOpen(true)}}>
          <PlusIcon size="xl"/>
        </div>
      </div>
    </div>      
